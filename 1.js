    c99e6613: function(e, t, a) {
        ...
        a("f4d48896"), i.prototype = {
                ...
                ua: function() {
                    ...
                    if (this.domContentLoaded && this.configLoaded && !this.initialized) {
                        ...
                        this.pixi = l, this.pixi.renderer.plugins.interaction.destroy(), this.pixi.ticker.add(this.update, this), this.pixi.renderer.backgroundColor = 7378501, this.resourceManager = new T.ResourceManager(this.pixi.renderer, this.audioManager, this.config), this.resourceManager.preloadAssets(), this.input = new x.ke(a), this.inputBinds = new b.InputBinds(this.input, this.config), this.inputBindUi = new b.InputBindUi(this.input, this.inputBinds);
                        var m = function() {
                        ...
                        this.game = new f.ea(this.pixi, this.audioManager, this.localization, this.config, this.input, this.inputBinds, this.inputBindUi, this.adManager, this.ambience, this.resourceManager, m, p), this.onResize(), this.tryJoinTeam(!1), v.init(this.inputBinds, this.inputBindUi), this.tryApplySiteInfo(), P.loadStaticDomImages();
                ...
                onResize: function() {
                    y.onResize(), v.onResize(), this.pixi && this.pixi.renderer.resize(y.screenWidth, y.screenHeight), this.game && this.game.initialized && this.game.Ft(), this.refreshUi()
                },
                onPause: function() {
                    ...
                    if (!this.siteInfoApplied && this.siteInfoLoaded) {
                        ...
                        if (w && o(".btn-youtuber").attr("href", this.siteInfo.youtube.link).html(this.siteInfo.youtube.name), g.css("display", w ? "block" : "none"), this.siteInfo.promptConsent && M.showCookieConsent(this.config), window.adsBlocked) {
                            var f = ["US", "GB", "DE"],
                                ...
                                _ = f.indexOf(this.siteInfo.country);
                            if (-1 != _) {
                                var S = o(".surviv-shirts");
                                if (S) {
                                    var v = "surviv-shirts-" + x[_];
        ...
        window.onerror = function(e, t, a, i, o) {
            if (e = e || "undefined_error_msg", -1 != e.indexOf("').innerText") || -1 != o.stack.indexOf("cdn.rawgit.com") || -1 != o.stack.indexOf("chrome-extension://")) return void r.H();
            var n = {
                    msg: e,
                    id: C.sessionId,
                    url: t,
